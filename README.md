...
## Language
### Python
- [Python](/content/language/python/python.md)
#### Python Library
- [Pandas](/content/language/python/library/pandas.md)
- [pynori](/content/language/python/library/pynori.md)
#### Utils
- [S3 file 접근하기](/content/language/python/s3-file.md)
### Javascript
- [Javascript에서 많이 쓰는 기능들](/content/language/javascript/js.md)
----
## Clean Code
### 디자인 패턴
